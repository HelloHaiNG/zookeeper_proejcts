package com.ucar.publishsubscribeserver2.server;
...
public class WorkServer {
    ...
    public void start() {
        logger.info("publishsubscribe-server2启动，准备初始化....");
        init();
    }

    public void init() {
        logger.info("publishsubscribe-server2 初始化........");
        ...
        if (!exists1) {
            zkClient.createEphemeral(serverPath.concat(ownServerPath),"WorkServer2".getBytes());
        }
