package com.ucar.masterclient2.server.impl;

import com.ucar.masterclient2.server.MasterService;
                    ...
                    public void process(WatchedEvent watchedEvent) {
                        if (watchedEvent.getType() == Event.EventType.NodeDeleted) {
                            ...
                            try {
                                ...
                                logger.info("删除节点/registry/slave/address-0000000014");
                                zk.delete("/registry/slave/address-0000000014", 0);
