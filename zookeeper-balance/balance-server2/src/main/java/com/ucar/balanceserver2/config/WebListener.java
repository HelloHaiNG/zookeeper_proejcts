package com.ucar.balanceserver2.config;

import com.ucar.balancecommon.entity.ServerData;
import com.ucar.balanceserver2.server.WorkServer;
...
public class WebListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        serverData.setServerIp("192.168.202.129");
        serverData.setServerName("/WorkServer2");
